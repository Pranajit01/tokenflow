 ...
 * - 100% Centered vertical alignment (mx-auto text-center items-center)
 * - Luxurious vertical spacing & card margins (zero crowding)
 * - AI Intent Engine Interactive Launcher Box
 * - Spacious 2-Column Capability Grid
 * - Spacious How-It-Works Step Cards
 */
...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#07080a] text-white flex flex-col items-center justify-between">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 pt-16 pb-28 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center text-center w-full mb-20">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight leading-[1.15] mb-8 max-w-3xl font-sans text-center">
          ...
          <div className="w-full max-w-3xl space-card text-left shadow-2xl overflow-hidden border border-white/20">
            {/* Input Header */}
        ...
        <div className="w-full mb-28">
          ...
          {/* Spacious Centered 2-Column Grid */}
          <div className="grid sm:grid-cols-2 gap-8 w-full">
            {FEATURES.map((feature, i) => {
              ...
              return (
                <div
                  key={i}
                  className="space-card p-8 flex flex-col justify-between text-left border border-white/15"
                >
                  <div>
        ...
        <div className="w-full mb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-8 w-full">
            {STEPS.map((step, i) => (
              <div key={i} className="space-card p-8 text-center flex flex-col items-center border border-white/15">
                ...
                <p className="text-xs text-white/70 leading-relaxed max-w-xs">{step.desc}</p>
              </div>
            ))}
          </div>
